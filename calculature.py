def my_final_grade_calculation(filename):
    ...
    for x in range(0, len(data)):
        ...
        assignments_score = (sum(assignments)/len(assignments)) * 0.25
        midterm_score = midterm * 0.25
        final_score = final * 0.25

        #calculate total score
        total_score = quiz_score + midterm_score + assignments_score + final_score
...
my_final_grade_calculation("student and score.txt")
